...
class Knight(pygame.sprite.Sprite):
    ...
    def __init__(self, screen):
        ...
        self.knight_list = []
        self.knight_index = 0
        self.knight = pygame.image.load("assets/knight/idle/knight_idle_anim_f0.png").convert_alpha()
        self.screen = screen
        ...
        # knight idle
        self.knight_idle_1 = pygame.image.load("assets/knight/idle/knight_idle_anim_f0.png").convert_alpha()
        self.knight_idle_1 = pygame.transform.rotozoom(self.knight_idle_1, 0, 3)
        self.knight_idle_2 = pygame.image.load("assets/knight/idle/knight_idle_anim_f1.png").convert_alpha()
        self.knight_idle_2 = pygame.transform.rotozoom(self.knight_idle_2, 0, 3)
        self.knight_idle_3 = pygame.image.load("assets/knight/idle/knight_idle_anim_f2.png").convert_alpha()
        self.knight_idle_3 = pygame.transform.rotozoom(self.knight_idle_3, 0, 3)
        self.knight_idle_4 = pygame.image.load("assets/knight/idle/knight_idle_anim_f3.png").convert_alpha()
        self.knight_idle_4 = pygame.transform.rotozoom(self.knight_idle_4, 0, 3)
        self.knight_idle_5 = pygame.image.load("assets/knight/idle/knight_idle_anim_f4.png").convert_alpha()
        self.knight_idle_5 = pygame.transform.rotozoom(self.knight_idle_5, 0, 3)
        self.knight_idle_6 = pygame.image.load("assets/knight/idle/knight_idle_anim_f5.png").convert_alpha()
        ...
        # knight run
        self.knight_run_1 = pygame.image.load("assets/knight/run/knight_run_anim_f0.png").convert_alpha()
        self.knight_run_1 = pygame.transform.rotozoom(self.knight_run_1, 0, 3)
        self.knight_run_2 = pygame.image.load("assets/knight/run/knight_run_anim_f1.png").convert_alpha()
        self.knight_run_2 = pygame.transform.rotozoom(self.knight_run_2, 0, 3)
        self.knight_run_3 = pygame.image.load("assets/knight/run/knight_run_anim_f2.png").convert_alpha()
        self.knight_run_3 = pygame.transform.rotozoom(self.knight_run_3, 0, 3)
        self.knight_run_4 = pygame.image.load("assets/knight/run/knight_run_anim_f3.png").convert_alpha()
        self.knight_run_4 = pygame.transform.rotozoom(self.knight_run_4, 0, 3)
        self.knight_run_5 = pygame.image.load("assets/knight/run/knight_run_anim_f4.png").convert_alpha()
        self.knight_run_5 = pygame.transform.rotozoom(self.knight_run_5, 0, 3)
        self.knight_run_6 = pygame.image.load("assets/knight/run/knight_run_anim_f5.png").convert_alpha()
        ...
        # sword
        self.sword_1 = pygame.image.load("assets/knight/weapon/weapon_sword_1.png").convert_alpha()
        ...
        self.sword_sound = pygame.mixer.Sound("assets/sounds/air_cut.wav")
