...
class Enemies(pygame.sprite.Sprite):
    ...
    def __init__(self, enemy, knight, screen):
        ...
        self.enemy = pygame.image.load("assets/enemies/slime/slime_run_anim_f0.png").convert_alpha()
        if enemy == 1:
            self.enemy_1 = pygame.image.load("assets/enemies/slime/slime_run_anim_f0.png").convert_alpha()
            self.enemy_1 = pygame.transform.rotozoom(self.enemy_1, 0, 3)
            self.enemy_2 = pygame.image.load("assets/enemies/slime/slime_run_anim_f1.png").convert_alpha()
            self.enemy_2 = pygame.transform.rotozoom(self.enemy_2, 0, 3)
            self.enemy_3 = pygame.image.load("assets/enemies/slime/slime_run_anim_f2.png").convert_alpha()
            self.enemy_3 = pygame.transform.rotozoom(self.enemy_3, 0, 3)
            self.enemy_4 = pygame.image.load("assets/enemies/slime/slime_run_anim_f3.png").convert_alpha()
            self.enemy_4 = pygame.transform.rotozoom(self.enemy_4, 0, 3)
            self.enemy_5 = pygame.image.load("assets/enemies/slime/slime_run_anim_f4.png").convert_alpha()
            self.enemy_5 = pygame.transform.rotozoom(self.enemy_5, 0, 3)
            self.enemy_6 = pygame.image.load("assets/enemies/slime/slime_run_anim_f5.png").convert_alpha()
            ...
            self.enemy_1 = pygame.image.load(
                "assets/enemies/flying-creature/fly_anim_f0.png").convert_alpha()
            self.enemy_1 = pygame.transform.rotozoom(self.enemy_1, 0, 3)
            self.enemy_2 = pygame.image.load(
                "assets/enemies/flying-creature/fly_anim_f1.png").convert_alpha()
            self.enemy_2 = pygame.transform.rotozoom(self.enemy_2, 0, 3)
            self.enemy_3 = pygame.image.load(
                "assets/enemies/flying-creature/fly_anim_f2.png").convert_alpha()
            self.enemy_3 = pygame.transform.rotozoom(self.enemy_3, 0, 3)
            self.enemy_4 = pygame.image.load(
                "assets/enemies/flying-creature/fly_anim_f3.png").convert_alpha()
            self.enemy_4 = pygame.transform.rotozoom(self.enemy_4, 0, 3)
